const DEPLOY_URL = 'https://script.google.com/macros/s/AKfycbype6ug9zCewtyeSrTOINnV7E4qv9Db_Q2MHGFAMsSOGTQAalWOs6iTEq3ogmKumZQ/exec'; // Replace with your Google Apps Script deployed URL
...
.then(data => {
    ...
    data.forEach((item, index) => {
        ...
        <input type="text" id="commentInput-${index}" placeholder="Enter your comment" class="input-hero" style="background: transparent; border-bottom: 2px solid #FFF; width: 87%; padding-left: 4px; margin-left: 20px;"/>
