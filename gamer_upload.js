...
document.getElementById('gamerForm').addEventListener('submit', function (e) {
    ...
    fetch('https://script.google.com/macros/s/AKfycbw08Hn8thfFpbLMjgSb4dCXkuCmxGj0A2cLdecJo-XuwlinpgMTiZW71URs3wv09dyX/exec', {
        method: 'POST',
        mode: 'no-cors',
        headers: {
...
document.getElementById('developerForm').addEventListener('submit', async function (e) {
    ...
    try {
        ...
        await fetch('https://script.google.com/macros/s/AKfycbxgq6OZ8aeZLmiPiiyppOGDw6cd-fO0b2QTZReVmyHfZREh2FOCp6vbpkyf8U6VZ1xi/exec', {
            method: 'POST',
            mode: 'no-cors',
            headers: {
                'Content-Type': 'application/json'
